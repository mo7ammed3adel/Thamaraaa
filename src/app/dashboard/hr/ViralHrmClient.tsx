...
function Profiles({ employees }: { employees: any[] }) {
  return (
...
function Departments({ departments, busy, onCreate, onDelete }: any) {
  return (
    <TwoColumn>
...
function PayrollPeriods({ data, month, busy, onCreate, onUpdate }: any) {
...
function Advances({ employees, advances, busy, onCreate, onUpdate }: any) {
  return (
    <TwoColumn>
...
function Recruitment({ departments, requests, busy, onCreate, onUpdate, onDelete }: any) {
  return (
    <TwoColumn>
...
function Kpis({ departments, templates, busy, onCreate, onUpdate, onDelete }: any) {
  return (
    <TwoColumn>
...
function PeopleOps({ employees, data, busy, onCreate, onUpdate, onDelete }: any) {
...
function Settings({ settings, busy, onUpdate }: any) {
  const keys = [
