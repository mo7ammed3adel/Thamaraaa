...
import TeamDashboardClient from "../social-media/TeamDashboardClient";
...
export default async function MediaBuyerPage() {
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold text-gray-900 mb-6">{isTL ? "Media Buying Team" : "My Campaigns"}</h1>
      <TeamDashboardClient
        tasks={tasks}
        agents={agents}
