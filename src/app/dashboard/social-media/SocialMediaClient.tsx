...
import { Search, X, ExternalLink, Plus, ChevronDown, ChevronUp } from "lucide-react";
...
export default function SocialMediaClient({ projects, teamMembers, userRole, userId }: any) {
  ...
  const isAgent = userRole === "agent_social_media";
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-6">
        {filteredProjects.map((project: any) => {
          ...
          const assignedAgents = project.teamAssignments?.filter((ta: any) => ta.role === "agent_social_media") || [];
      ...
      {reassignTask && (
        <TaskReassignModal
          ...
          leaderRole="team_leader_social_media"
