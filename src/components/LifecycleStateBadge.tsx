...
const STATE_STYLES: Record<string, { bg: string; text: string; ring: string }> = {
  [LIFECYCLE_STATE.ONBOARDING]: { bg: "bg-blue-50", text: "text-blue-700", ring: "ring-blue-200" },
  [LIFECYCLE_STATE.ACTIVE]: { bg: "bg-emerald-50", text: "text-emerald-700", ring: "ring-emerald-200" },
  [LIFECYCLE_STATE.ON_HOLD]: { bg: "bg-amber-50", text: "text-amber-700", ring: "ring-amber-200" },
  [LIFECYCLE_STATE.COMPLETED]: { bg: "bg-slate-50", text: "text-slate-600", ring: "ring-slate-200" },
  [LIFECYCLE_STATE.CHURNED]: { bg: "bg-red-50", text: "text-red-700", ring: "ring-red-200" },
};

const STATE_LABELS: Record<string, string> = {
  [LIFECYCLE_STATE.ONBOARDING]: "Onboarding",
  [LIFECYCLE_STATE.ACTIVE]: "Active",
  [LIFECYCLE_STATE.ON_HOLD]: "On Hold",
  [LIFECYCLE_STATE.COMPLETED]: "Completed",
  [LIFECYCLE_STATE.CHURNED]: "Churned",
};
