...
const BASE_PRESETS: { value: DateRangePreset; labelKey: MessageKey }[] = [
  { value: "today", labelKey: "dateRange.today" },
  { value: "yesterday", labelKey: "dateRange.yesterday" },
  { value: "this_week", labelKey: "dateRange.thisWeek" },
  { value: "this_month", labelKey: "dateRange.thisMonth" },
  { value: "last_7_days", labelKey: "dateRange.last7Days" },
  { value: "last_30_days", labelKey: "dateRange.last30Days" },
];
...
export default function DateRangeFilter({
  ...
  const presets = includeLastMonth
    ? [...BASE_PRESETS, { value: "last_month" as DateRangePreset, labelKey: "dateRange.lastMonth" as MessageKey }]
    : BASE_PRESETS;
      ...
      <div className="flex flex-col lg:flex-row lg:items-end gap-4">
        ...
        <div className="flex flex-wrap items-end gap-3 flex-1">
          <label className="block">
            <span className="block text-xs font-semibold text-gray-500 mb-1 uppercase">{t("dateRange.from")}</span>
            <input
              type="date"
              value={fromDate}
          ...
          <label className="block">
            <span className="block text-xs font-semibold text-gray-500 mb-1 uppercase">{t("dateRange.to")}</span>
            <input
              type="date"
              value={toDate}
